...
const TabsContext = createContext<null | { containerRef: RefObject<HTMLDivElement | null>, nested: boolean }>(null);
...
export function CodeBlock({ Actions = props => <div {...props} className={cn('empty:hidden', props.className)} />, allowCopy = true, children, icon, keepBackground = false, ref, title, viewportProps = {}, ...props }: CodeBlockProps) {
	//
