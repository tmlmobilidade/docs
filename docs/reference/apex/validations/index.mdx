...
| category              | ENUM         | categoria do tipo de título de transporte utilizado:  <br/>ocasional a bordo -> on_board_sale  <br/>ocasional pré-pago -> prepaid  <br/>passe mensal -> subscription                |
