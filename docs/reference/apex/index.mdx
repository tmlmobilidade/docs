...
Existem vários tipos de transações, onde cada uma representa um tipo de ação em particular. Cada uma tem uma estrutura própria, e relacionam-se entre si através de propriedades comuns. 