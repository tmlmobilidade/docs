...
|-----------------------|--------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| _id                   | GUID         | Identificador único do evento de venda.                                                                                                                                      |
...
| price                 | STRING       | Preço em céntimos de EUR, associado ao evento.                                                                                                                               |
| product_long_id       | NUM          | Identificador do produto, ou seja, do tipo de título da viagem que está a ser vendido.                                                                                       |
| product_quantity      |              | Número de unidades vendidas/carregadas no cartão referntes a este evento.                                                                                                    |
