...
Venda a bordo é um evento referente a uma compra de um título de viagem já a bordo do veículo onde vai decorrer essa viagem. Esse evento é transmitido como transação APEX do tipo on-board_sales, com um conjunto de campos próprios que caracterizam um evento desse tipo.
