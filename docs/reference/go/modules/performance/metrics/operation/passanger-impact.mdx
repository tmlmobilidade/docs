---
title: demand_affected_by_failed_circulations_by_day
description: A métrica "demand_affected_by_failed_circulations_by_day" estima o número de passageiros potencialmente afetados por falhas de circulação, agregado por agency_id e por dia operacional.
---
O cálculo é feito da seguinte forma:

1. São identificadas as circulações com falha (analysis.SIMPLE_ONE_APEX_VALIDATION.grade = "fail" e analysis.SIMPLE_THREE_VEHICLE_EVENTS.grade = "fail")
