...
Se aparecer o erro abaixo é possível que seja bloqueada a execução da ferramenta no powershell devido a permissões, para resolver o erro abra e execute a ferramenta no CMD (linha de comandos)
