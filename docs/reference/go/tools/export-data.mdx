...
⚠️ Se surgir o erro abaixo, é porque a execução da ferramenta esta a ser bloqueada. Isso ocorrer porque o PowerShell, devido a restrições de permissões dos utilizadores, impede a exportação de dados.
