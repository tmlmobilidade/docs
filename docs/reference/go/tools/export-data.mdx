...
⚠️ Se surgir o erro abaixo, é por a execução da ferramenta esta a ser bloqueada. Isso ocorrer porque o PowerShell, devido a restrições de permissões de utilizadores, impede a exportação de dados.
