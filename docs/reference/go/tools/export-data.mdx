...
Se aparecer o erro abaixo é possivel que seja bloqueada a execução da ferramenta no powershell devido a permissões, para resolver o erro isso abra o CMD (linha de comandos)
