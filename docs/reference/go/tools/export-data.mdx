...
Se aparecer o erro abaixo é possivel que seja bloqueada a execução da ferramenta e estar no powershell e por motivos de permissões bloqueia o export data para isso abra o CMD (linha de comandos)
