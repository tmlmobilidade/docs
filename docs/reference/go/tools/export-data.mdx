...
Se aparecer o erro abaixo devido a permissões é bloqueada a execução da ferramenta no powershell, para resolver o erro abra e execute a ferramenta no CMD (linha de comandos)
