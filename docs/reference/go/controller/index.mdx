...
Este módulo é responsável por transformar a informação contida nos GTFS estáticos em [circulações ou `rides`](/reference/glossary#circulação) e analisar cada uma individualmente, combinando as posições GPS dos veículos e as transações de bilhética APEX.
