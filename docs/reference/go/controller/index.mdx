...
Este módulo é responsável por transformar a informação contida nos GTFS estáticos (planos de operação) em [circulações](/reference/glossary#circulação) e analisar cada uma individualmente, combinando as posições GPS dos veículos e as transações de bilhética APEX.
