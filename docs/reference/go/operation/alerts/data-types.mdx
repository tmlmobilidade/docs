...
description: O modelo de dados do alerta e que campos compõem a nossa estrutura interna.
---
...
Para mais informações, consulte o modelo de dados mais atualizado no [github](https://github.com/tmlmobilidade/go/tree/production/packages/types/src/alerts).