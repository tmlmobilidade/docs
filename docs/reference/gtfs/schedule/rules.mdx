...
description: Possiveis erros que motivaram ao erro do campo
---
...
| `agency_name` | Texto    | Obrigatório                  | Nome completo da agência de transporte. Esse campo tende a dar erro se o nome introduzido não corresponder ao nome completo da agência ou se for introduzido o `agency_id` corresponder ao id                                                                                                                                                                                                                                                                                                         |
