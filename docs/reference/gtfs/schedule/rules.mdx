...
| `trip_headsign_group_validation` | O `pattern_id` utiliza diferentes `trip_headsign`. | Valida se no mesmo `pattern_id` existe a utilização de diferentes `trip_headsign`. | -             |             |
