...
| ID da Regra         | Título                                                              | Descrição                                                                                                                                                                                    | GTFS Standard | GTFS TML    |
| ------------------- | ------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------- | ----------- |
| `pattern_id_format` | O `pattern_id` não corresponde a um formato valido.                 | Valida se o `pattern_id` corresponde a um formato valido, por defeito é X ATEXXXX_X_X mas existe algumas exceções que podem conter outros formatos                                           | -             | Obrigatório |
