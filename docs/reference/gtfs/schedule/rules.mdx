...
| `License_plate`     | A `License_plate` não corresponde a formato devidamente correto | Valida se a `License_plate` corresponde ao formato devidamente correto estabelecido que é AA00AA ou 00AA00.<br><br>Pode aparecer aviso se não for introduzido sem "-" por exemplo AA-00-AA | -             | Obrigatório |
