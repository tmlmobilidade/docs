...
| `trip_headsign_group_validation` | O `pattern_id` utiliza diferentes `trip_headsign`. | Valida se no mesmo `pattern_id` existe a utilização de diferentes `trip_headsign`. | -             | Obrigatório |
...
| ID da Regra         | Título                                                              | Descrição                                                                                                                                                                                    | GTFS Standard | GTFS TML    |
| ------------------- | ------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------- | ----------- |
| `pattern_id_format` | O `pattern_id` não corresponde a um formato valido.                 | Valida se o `pattern_id` corresponde a um formato valido, por defeito é X_X_X até XXXX_X_X mas existe algumas exceções que podem conter outros formatos                                      | -             | Obrigatório |
