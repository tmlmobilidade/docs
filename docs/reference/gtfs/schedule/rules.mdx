...
| nome_agency   | Texto    | Obrigatório                  | Nome completo da agência de transporte.<br><br>Pode dar erro se o nome introduzido pela não corresponder ao nome correto da agência ou se for introduzido o                                                                                                                                                                                                                                                                                                                                           |
