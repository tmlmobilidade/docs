...
A validação exige o valor preenchido e que o número pertença a esse conjunto de códigos. A severidade de erro obedece às regras, ou  por outro tipo de severidade como aviso.
