...
- Para aquele `pattern_id`, depois de normalizar vazio e ausente para o mesmo significado, só pode existir um “tipo” de headsign: ou todas as viagens com o mesmo destino em texto, ou todas sem destino explícito (vazio/ausente de forma homogénea).
