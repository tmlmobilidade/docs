...
O campo identifica a matrícula do veículo, é obrigatório e deve corresponder a um formato reconhecido após tratar o texto: conversão para maiúsculas, remoção de separadores habituais (hífens, espaços, etc.) e exactamente seis caracteres alfanuméricos, obedecendo a um dos padrões de matrícula portugueses suportados pelo validador (variações do tipo pares de letras e algarismos, incluindo formatos clássicos e mais recentes, conforme a expressão de validação do projecto).
