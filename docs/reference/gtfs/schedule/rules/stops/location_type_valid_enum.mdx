...
| ------------- | ---- | -------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
|               |      |          | Tipo de localização.<br><br>Opções válidas:<br><br>- 0 (ou vazio) - Parada (ou Plataforma). Local onde os passageiros embarcam ou desembarcam de um veículo de transporte público. É chamada de plataforma quando definida dentro de uma estação principal (parent_station).<br>- 1 - Estação. Estrutura física ou área que contém uma ou mais plataformas.<br>- 2 - Entrada/Saída. Local onde os passageiros podem entrar ou sair de uma estação a partir da rua. Se uma entrada/saída pertencer a várias estações, ela poderá ser vinculada por caminhos a ambas, mas o provedor de dados deve escolher uma delas como principal.<br>- 3 - Nó Genérico. Local dentro de uma estação, que não corresponde a nenhum outro tipo de localização, e que pode ser usado para conectar caminhos definidos em pathways.txt.<br>- 4 - Área de Embarque. Local específico em uma plataforma, onde os passageiros podem embarcar e/ou desembarcar de veículos. |
