---
title: Mapa de rede na paragem válido de acordo com o enumerado do GTFS
...
| ----------------- | ---- | -------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `has_network_map` | Enum | Opcional | Indica se na paragem existe um mapa da rede.<br/><br/><strong>Opções válidas:</strong><ul><li><code>0</code> — Não aplicável a esta paragem.</li><li><code>1</code> — Paragem sem mapa da rede.</li><li><code>2</code> — Tem mapa da rede, mas em mau estado.</li><li><code>3</code> — Tem mapa da rede e está em bom estado.</li></ul> |

## O que esta validação faz 

No ficheiro `stops.txt`, o campo `has_network_map` descreve se a paragem dispõe de mapa da rede, e em que estado: não aplicável, sem mapa, com mapa em mau estado ou com mapa em bom estado. No feed o campo é opcional; deixar o campo vazio é aceite no standard - significa não fornecer essa informação. O validador aplica as regras  sobre presença, proibição, valores permitidos (0 a 3) e, se existir, lista de opções permitidas.
