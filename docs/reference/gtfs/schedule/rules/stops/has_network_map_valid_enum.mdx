...
| ----------------- | ---- | -------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `has_network_map` | Enum | Opcional | Indica se a paragem possui um mapa da rede.<br/><br/>Opções validas<br/><br/>- `0` - Não aplicável para esta paragem<br/>- `1` - A paragem não possui mapa da rede<br/>- `2` - Possui mapa da rede, mas está em mau estado<br/>- `3` - Possui mapa da rede e está em bom estado |
