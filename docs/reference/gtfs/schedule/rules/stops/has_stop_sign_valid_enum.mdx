...
| --------------- | ---- | -------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `has_stop_sign` | Enum | Opcional | Indica se o ponto de parada possui placa de pare.<br><br>Opções validas:<br><br>- 0 - Não aplicável a este ponto de parada<br>- 1 - O ponto de parada não possui placa de pare<br>- 2 - Possui placa de pare, mas está em mau estado<br>- 3 - Possui placa de pare e está em bom estado |
