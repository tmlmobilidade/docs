...
| ------------- | ---- | -------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `has_shelter` | Enum | Opcional | Indica se a paragem tem abrigo para os passageiros.<br/><br/><strong>Opções válidas:</strong><ul><li><code>0</code> — Não aplicável a esta paragem.</li><li><code>1</code> — Paragem sem abrigo.</li><li><code>2</code> — Tem abrigo, mas em mau estado.</li><li><code>3</code> — Tem abrigo e está em bom estado.</li></ul> |
