...
| ------------- | ---- | -------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `has_shelter` | Enum | Opcional | Describes if the stop has a shelter.<br><br>Opções validas:  <br><br>- 0 - Not Applicable for this stop<br><br>- 1 - Stop has no shelter<br><br>- 2 - Has shelter but is in bad condition<br><br>- 3 - Has shelter and is in good condition |
