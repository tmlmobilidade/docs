...
| ------------- | -------- | -------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `stop_id`     | ID único | Opcional | Identifica uma localização: paragem/plataforma, estação, entrada/saída, nó genérico ou área de embarque (consulte location_type).<br/><br/>O ID deve ser único em todos os valores de stops.stop_id, locations.geojson_id e location_groups.location_group_id. |
