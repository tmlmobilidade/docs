...
| ------------------- | ---- | -------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `has_pip_real_time` | Enum | Opcional | Indica se a parada possui informações em tempo real.<br/><br/>Opções validas<br/><br/> `0` - Não aplicável para esta parada<br/> `1` - Possui informações em tempo real, mas está em mau estado<br/> `2` - Possui informações em tempo real e está em boas condições |
