...
| ------------------- | ---- | -------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `has_pip_real_time` | Enum | Opcional | Indica se a paragem possui informações em tempo real.<br/><br/>Opções validas<br/><br/> `0` - Não aplicável para esta paragem<br/> `1` - Possui informações em tempo real, mas está em mau estado<br/> `2` - Possui informações em tempo real e está em boas condições |
