...
| ------------- | ---- | -------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `has_bench`   | Enum | Opcional | Identifica se existe um banco na paragem<br><br>Opções validas<br><br>- `0` - Não aplicável para esta paragem<br>- `1` - Stop não tem banco<br>- `2` - Tem banco mas está em mau estado<br>- `3` - Tem banco e está em bom estado |
