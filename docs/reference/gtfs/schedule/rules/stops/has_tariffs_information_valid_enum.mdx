...
| ------------------------- | ---- | -------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `has_tariffs_information` | Enum | Opcional | Indica se a paragem possui informações sobre tarifas.<br/><br/>Opções validas:<br/><br/>- 0 - Não aplicável a esta paragem<br/>- 1 - A paragem não possui informações sobre tarifas<br/>- 2 - Possui informações sobre tarifas, mas estão em mau estado<br/>- 3 - Possui informações sobre tarifas e estão em bom estado |
