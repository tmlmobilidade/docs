---
title: Informação tarifária na paragem válida de acordo com o enumerado do GTFS
...
| ------------------------- | ---- | -------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `has_tariffs_information` | Enum | Opcional | Indica se na paragem existe informação sobre tarifas.<br/><br/><strong>Opções válidas:</strong><ul><li><code>0</code> — Não aplicável a esta paragem.</li><li><code>1</code> — Paragem sem informação sobre tarifas no local.</li><li><code>2</code> — Há informação sobre tarifas, mas em mau estado.</li><li><code>3</code> — Há informação sobre tarifas e está em bom estado.</li></ul> |
