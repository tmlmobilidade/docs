...
| --------------- | ---- | -------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `has_schedules` | Enum | Opcional | Indica se a paragem possui horários.<br/><br/>Opções validas:<br/><br/>- 0 - Não aplicável para esta paragem<br/>- 1 - A paragem não possui horários<br/>- 2 - Possui horários, mas está em mau estado<br/>- 3 - Possui horários e está em bom estado |
