...
| --------------- | ---- | -------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `has_schedules` | Enum | Opcional | Indica se a parada possui horários.<br><br>opções validas<br><br>- 0 - Não aplicável para esta parada<br>- 1 - A parada não possui horários<br>- 2 - Possui horários, mas está em mau estado<br>- 3 - Possui horários e está em bom estado |
