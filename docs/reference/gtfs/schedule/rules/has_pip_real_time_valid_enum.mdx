...
| ------------------- | ---- | -------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `has_pip_real_time` | Enum | Opcional | Indica se na paragem existe informação em tempo real.<br/><br/><strong>Opções válidas:</strong><ul><li><code>0</code> — Não aplicável a esta paragem.</li><li><code>1</code> — Há informação em tempo real, mas em mau estado.</li><li><code>2</code> — Há informação em tempo real em bom estado.</li></ul> |
