...
description: "Valida o campo arrival_time em stop_times.txt: tempo bem formado, obrigação na primeira e última paragem da viagem e quando timepoint = 1, incompatibilidade com janelas de pickup/drop-off na mesma linha, e mensagens de presença conforme o modo de validação."
---
