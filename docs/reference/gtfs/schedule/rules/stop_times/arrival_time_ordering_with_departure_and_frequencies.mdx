---
title: Hora de Chegada ordenado de acordo com partida e frequências
description: arrival_time_ordering_with_departure_and_frequencies
---
...
O campo `arrival_time` é a hora de chegada à paragem (fuso da agência). O GTFS permite horas acima de 24 após meia-noite do dia de serviço; quando não há distinção prática entre chegada e partida, estes campos devem coincidir - ver referência do feed.
