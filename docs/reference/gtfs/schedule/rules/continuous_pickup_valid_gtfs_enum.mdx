...
No ficheiro `route.txt`,  o campo `continuous_pickup` indica se o utente pode embarcar em qualquer ponto ao longo do percurso do veículo (alinhado com a forma da linha), nas viagens dessa rota. 
