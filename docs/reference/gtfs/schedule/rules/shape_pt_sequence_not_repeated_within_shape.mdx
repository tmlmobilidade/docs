...
No ficheiro `agency.txt`,  o campo `shape_pt_sequence` define a ordem em que os pontos da mesma forma se ligam ao longo do percurso. Pelo GTFS, os valores devem aumentar ao longo da viagem mas não precisam de ser consecutivos (ex.: 0, 6, 11).
