...
O campo indica o sentido da viagem (por exemplo ida ou volta), para apoio a horários e separação de viagens por direcção; não é usado para o cálculo de itinerários no GTFS. No standard o campo é opcional. O validador trata a presença conforme as regras , exige que o valor seja 0 ou 1 quando existe, pode marcar o campo como proibido e pode restringir a subconjuntos de opções nas regras.
