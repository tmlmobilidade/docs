...
- O comentário no topo valida se stop_lat e stop_lon são válidos é genérico; o comportamento concreto é “distância paragem ↔ shape da viagem” usando caches, não um validador isolado de intervalo lat/lon neste ficheiro.
