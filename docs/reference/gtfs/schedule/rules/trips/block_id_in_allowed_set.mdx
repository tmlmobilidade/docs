...
No ficheiro `trips.txt`, o campo `block_id` liga a viagem a um bloco - a sequência de serviço em que a mesma unidade cumpre uma ou mais viagens encadeadas, conforme a modelação do GTFS. No standard o campo é opcional; o validador aplica, em cima disso, a regra pode recomendar ou exigir o preenchimento, ignorar a verificação ou tratar o campo como proibido quando o valor vem fornecido.
