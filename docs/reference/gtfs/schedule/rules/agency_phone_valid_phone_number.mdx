...
O campo `agency_phone` prevê um número de telefone facultativo para o operador, apresentado como é habitual na área de serviço. Trata-se a ausência conforme a regra (obrigatório, recomendado ou ignorado) e recusa-se o campo quando a regra o proíbe. Quando o valor é introduzido, esta verificação exige que o texto não seja vazio só com espaços, que só contenha caracteres permitidos para telefone (algarismos, letras, espaços e alguns separadores habituais) e que inclua pelo menos sete algarismos.
