...
| Versão | Path                 | Descrição                                                                                                   | URL                                                                 |
| ------ | -------------------- | ----------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------- |
| `/v1`  | `/network/stops`     | Todas as paragens de todos os operadores. Este endpoint pode devolver paragens de zonas que não são da AML. | [Abrir](https://go.tmlmobilidade.pt/hub/api/v1/operation/stops)     |
| `/v1`  | `/network/stops/:id` | Detalhe de uma paragem específica, com informação adicional.                                                | [Abrir](https://go.tmlmobilidade.pt/hub/api/v1/operation/stops/000) |
| `/v1`  | `/network/lines`     | Todas as linhas de todos os operadores em operação num determinado momento.                                 | [Abrir](https://go.tmlmobilidade.pt/hub/api/v1/operation/lines)     |

### Tempo Real
Informação em tempo real da rede de transportes. Dispomos também

| Versão | Path                    | Descrição                                                                                                                                               | URL                                                                   |
| ------ | ----------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------- |
| `/v1`  | `/realtime/vehicles`    | Todos os veículos de todos os operadores em operação num determinado momento, em JSON. Sugerimos uma atualização a cada 3 segundos para dados recentes. | [Abrir](https://go.tmlmobilidade.pt/hub/api/v1/operation/vehicles)    |
| `/v1`  | `/realtime/vehicles.pb` | Todos os veículos de todos os operadores em operação num determinado momento, em Protobuf e no formato standard GTFS-RT Vehicle Positions.              | [Abrir](https://go.tmlmobilidade.pt/hub/api/v1/operation/vehicles.pb) |
